...
public class Subscription extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            Toast.makeText(Subscription.this, "Payment gateway Username Required!", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(pass))
        {
            Toast.makeText(Subscription.this, "Payment gateway Password Required!", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(key_s))
        {
            Toast.makeText(Subscription.this, "key missing!", Toast.LENGTH_SHORT).show();
        }
        else if (TextUtils.isEmpty(details_josn))
        {
            Toast.makeText(Subscription.this, "data missing!", Toast.LENGTH_SHORT).show();
        }
        else
        {
